...
- `folder`: the fullname to the folder where to store files generated by the script;
- `empty`: 1 to first empty that folder before starting to generate new files.
